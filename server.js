...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "123", email: "t@t.com", password: "tt", name: "Temo" })
    },
    ...
    routes() {
        ...
        this.get("/vans", (schema, request) => {
            // Trigger a failed response when the client includes `?fail=true`
            const shouldFail = request.queryParams?.fail === "true"
            if (shouldFail) {
